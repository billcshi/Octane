all: proja
proja: proja.o task_config.o ./Stage1/stage1main.o ./Stage2/stage2main.o ./Stage3/stage3main.o ./Stage4/stage4main.o ./timers/tools.o ./timers/timers.o ./Router/OctaneManager.o ./Router/router.o ./Router/PrimaryRouter.o ./GlobalVar.o ./Router/sample_tunnel.o ./Datagram/IPDatagram.o ./Datagram/icmp_checksum.o
	g++ -g ./task_config.o ./proja.o ./Stage1/stage1main.o ./Stage2/stage2main.o ./Stage3/stage3main.o ./Stage4/stage4main.o ./timers/tools.o ./timers/timers.o ./Router/OctaneManager.o ./Router/router.o ./Router/PrimaryRouter.o ./Router/sample_tunnel.o ./GlobalVar.o ./Datagram/IPDatagram.o ./Datagram/icmp_checksum.o -o ./proja
proja.o: proja.cpp
