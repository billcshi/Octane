all: proja
proja: proja.o task_config.o ./Stage1/stage1main.o ./Stage2/stage2main.o ./Stage3/stage3main.o ./Router/router.o ./GlobalVar.o ./Router/sample_tunnel.o ./Datagram/icmp_checksum.o
	g++ -g ./task_config.o ./proja.o ./Stage1/stage1main.o ./Stage2/stage2main.o ./Stage3/stage3main.o ./Router/router.o ./Router/sample_tunnel.o ./GlobalVar.o ./Datagram/icmp_checksum.o -o ./proja
proja.o: proja.cpp
